...
class PDP_Service_Categories_Carousel extends \Elementor\Widget_Base {
	public function __construct( $data = [], $args = null ){
		...
		wp_register_script( 'pdp-service-categories-carousel', get_template_directory_uri() . '/js/elementor/service-categories-carousel.js', [ 'elementor-frontend' ], _S_VERSION, true );
	}
