            ...
            <div class="row row_1-2 gap_col_80px flex_alignCenter">
                ...
                <div class="col">
                    <div class="title mb_10px mb_20px_m">
                        <h1 class="title__heading txt_fs-64px txt_lh-64px txt_fs-36px_m txt_lh-36px_m">подарочные сертификаты</h1>
                    </div>
            ...
            <div class="row row_1-2 gap_col_80px">
                <div class="col">
                    <div class="textBlock txt_fs-24px txt_lh-24px mb_40px_m txt_fs-18px_m txt_lh-18px_m">
                        <p>подарочный сертификат будет <strong>по-настоящему</strong> ценен и не будет пылиться в углу</p>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="row row_1-1 gap_col_70px gap_row_54px" id="gift-cards-icons-large">
                        <div class="iconBox">
                            ...
                            <div class="iconBox__title txt_fs-16px txt_lh-16px">Кроме обслуживания, владелец сертификата получает консультацию от топ-мастеров с 10 и более летним опытом</div>
                        </div>
                        ...
                        <div class="iconBox">
                            ...
                            <div class="iconBox__title txt_fs-16px txt_lh-16px">Подарочный сертификат PIED&#8209;DE&#8209;POULE будет действителен ровно 365 дней со дня покупки</div>
                        </div>
                        ...
                        <div class="iconBox">
                            ...
                            <div class="iconBox__title txt_fs-16px txt_lh-16px">Наш сертификат подойдет в подарок как женщинам так и мужчинам</div>
                        </div>
                        ...
                        <div class="iconBox">
                            ...
                            <div class="iconBox__title txt_fs-16px txt_lh-16px">Сертификатом можно воспользоваться в любой день, любое время, в любом салоне</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="title txt_center mb_40px">
                    <h2 class="title__heading txt_fs-36px txt_lh-36px txt_fs-24px_m txt_lh-24px_m">Заказать подарочный сертификат</h2>
                </div>

                <div class="title txt_center mb_20px d_none_m   ">
                    <h3 class="title__heading txt_lh-28px">номиналы сертификатов могут быть</h3>
                </div>
                ...
                <div class="row row_1-1 gap_col_40px gap_row_24px mb_50px">
                    <div class="iconBox">
                        ...
                        <div class="iconBox__title txt_fs-16px txt_lh-16px">Любая денежная сумма</div>
                    </div>
                    ...
                    <div class="iconBox">
                        ...
                        <div class="iconBox__title txt_fs-16px txt_lh-16px">Безлимит на год</div>
                    </div>
                </div>
