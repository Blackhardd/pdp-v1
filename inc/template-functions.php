...
function pdp_add_analytics(){ ?>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-57306807-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-57306807-1');
    </script>
    ...
    <script>
        ...
        fbq('init', '707195393025403');
        fbq('track', 'PageView');
    </script>
    <noscript>
        <img height="1" width="1" src="https://www.facebook.com/tr?id=707195393025403&ev=PageView&noscript=1"/>
    </noscript>
