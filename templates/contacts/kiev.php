...
<div class="title mb_30px">
	<h3 class="title__heading">Салоны в Киеве <span class="txt_fw-600 txt_color_primary"><?=count( $kiev_salons ); ?></span></h3>
</div>

<div class="accordion mb_50px_m">
	<?php foreach( $kiev_salons as $salon ){
