<div class="title mb_30px">
	<h3 class="title__heading">Салоны во Владимире-Волынском <span class="txt_fw-600 txt_color_primary">1</span></h3>
</div>

<div class="accordion mb_50px_m">
	<div class="accordion__item">
		<div class="accordion__item-header">
			...
			<div class="accordion__title"><span>PIED-DE-POULE</span> на Князя Василька</div>
		</div>
		<div class="accordion__content">
			<div class="contacts-list">
				<div class="contacts-list__address">
					...
					<a href="https://goo.gl/maps/rS4Byxkm5idxpD3dA" target="_blank">ул. Князя Василька, 12а</a>
				</div>
				<div class="contacts-list__email">
					...
					<a href="mailto:pdp_vv@p-de-p.com">pdp_vv@p-de-p.com</a>
				</div>
				<div class="contacts-list__phone">
					...
					<a href="tel:+380932195921">+380 (93) 219 59 21</a>
				</div>
			</div>
		</div>
	</div>
