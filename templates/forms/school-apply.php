<div class="school-apply-form">
    <h2>Оставить заявку<br>на обучение</h2>
    <form class="form">
        <div class="form__row">
            ...
            <div class="form__col_half">
                <div class="inputWrap inputWrap_iconed">
                    <div class="inputWrap__input">
                        ...
                        <input type="email" name="email" class="input input_tel" placeholder="Электронная почта" />
                    </div>
                    <div class="inputWrap__errors"></div>
                </div>
            </div>
                ...
                <div class="inputWrap">
                    <div class="inputWrap__input">
                        <select name="service" class="selectric selectric_pdp iconed iconed_service">
                            ...
                            <option value="Коллорист">Курс “Коллорист”</option>
                            <option value="Make-up специалист">Курс “Make-up специалист”</option>
                            <option value="Коммерческий макияж">Курс “Коммерческий макияж”</option>
                        </select>
                    </div>
                    <div class="inputWrap__errors"></div>
                </div>
