<div class="cv-form">
    <h3 class="cv-form__heading"><?=__( 'Оставить заявку', 'pdp' ); ?></h3>
                    ...
                    <div class="form__col_full">
                        <div class="inputWrap inputWrap_iconed">
                            <div class="inputWrap__input">
                                ...
                                <input type="email" name="email" class="input input_email" placeholder="<?=__( 'Электронная почта', 'pdp' ); ?>" required>
                            </div>
                            <div class="inputWrap__errors"></div>
                        </div>
                    </div>
            ...
            <div class="col">
                <div class="form__row">
                    <div class="form__col_full">
                        <div class="inputWrap">
                            <div class="inputWrap__input">
                                <textarea name="message" class="input input_textarea" placeholder="<?=__( 'Подробнее о вас...', 'pdp' ); ?>"></textarea>
                            </div>
                            <div class="inputWrap__errors"></div>
                        </div>
                    </div>
