<div class="cv-form">
    <h3 class="cv-form__heading">Оставить заявку</h3>
    <form class="form" enctype="multipart/form-data">
        ...
        <div class="row row_1-1 gap_col_8px">
            <div class="col">
                <div class="form__row">
                    ...
                    <div class="form__col_full">
                        <div class="inputWrap inputWrap_iconed">
                            <div class="inputWrap__input">
                                ...
                                <input type="email" name="email" class="input input_email" placeholder="Электронная почта" required>
                            </div>
                            <div class="inputWrap__errors"></div>
                        </div>
                    </div>
            ...
            <div class="col">
                <div class="form__row">
                    <div class="form__col_full">
                        <div class="inputWrap">
                            <div class="inputWrap__input">
                                <textarea name="message" class="input input_textarea" placeholder="Подробнее о вас..."></textarea>
                            </div>
                            <div class="inputWrap__errors"></div>
                        </div>
                    </div>
        ...
        <div class="form__submit">
            <input type="submit" class="btn-default" value="оставить заявку">

            <label for="cv-input" class="cv-form__file-label">
                <svg width="19" height="22" fill="none"><path d="M14 0H2a2 2 0 00-2 2v14h2V2h12V0zm-1 4l6 6v10a2 2 0 01-2 2H6a2 2 0 01-2-2V6c0-1.1.9-2 2-2h7zm-1 7h5.5L12 5.5V11z" fill="#fff"/></svg>
            </label>
            <input type="file" name="attachment" accept=".pdf,.doc" id="cv-input" class="cv-form__file-input">
        </div>
