<div class="cart" id="cart-sidebar">
    <div class="backdrop" :class="{ active: sharedState.isCartLoading }"><div class="loader"><div class="dot"></div><div class="dot"></div><div class="dot"></div><div class="dot"></div></div></div>
    <form class="form cart-form cart__form" @submit.prevent="submitAppointment">
        ...
        <div class="form__row">
            <div class="form__col_full">
                <div class="inputWrap inputWrap_iconed">
                    ...
                    <input type="email" name="email" class="input input_email" placeholder="Электронная почта" v-model="email" required>
                </div>
            </div>
        </div>
        ...
        <div class="form__row">
            <div class="form__col_full">
                <div class="inputWrap">
                    <pdp-select @changed="changeSalon" name="salon" placeholder="Выберите салон" classes="" :options="sharedState.salons" :selected="sharedState.currentSalon" />
                </div>
            </div>
        </div>
